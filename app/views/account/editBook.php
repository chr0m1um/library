...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-4 mx-auto">
            <h1>Змінити дані</h1>
            <form action="<?php echo ROUTE_URL; ?>account/editBook/<?php echo $data['id_book'] // get book ID ?>" method="POST">
                ...
                <div class="form-group">
                    <input type="text" name="year" class="form-control" placeholder="Телефон" value="<?php echo $data['year']; ?>" required><br>
                </div>
